...
def test_registration_page_with_empty_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("Попова")
    reg_page.email_or_mobile_phone_field.send_keys("u15618793@gmail.com")
    reg_page.password_field.send_keys("261320261320Aleks")
    reg_page.password_confirmation_field.send_keys("261320261320Aleks")
...
def test_registration_with_an_incorrect_value_in_the_last_name_field(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("Александра")
    reg_page.last_name_field.send_keys("Шпвмыевпыакевлараыквеанспвеыааыгвь")
    reg_page.email_or_mobile_phone_field.send_keys("u15618793@gmail.com")
    reg_page.password_field.send_keys("261320261320Aleks")
    reg_page.password_confirmation_field.send_keys("261320261320Aleks")
    reg_page.continue_button.click()
...
def test_registration_of_an_already_registered_user(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("Екатерина")
    reg_page.last_name_field.send_keys("Иванова")
    reg_page.email_or_mobile_phone_field.send_keys("+79042482516")
    reg_page.password_field.send_keys("Zxcvbnm9876!")
    reg_page.password_confirmation_field.send_keys("Zxcvbnm9876!")
    reg_page.continue_button.click()
...
def test_incorrect_password_during_registration(web_browser):
    ...
    reg_page.last_name_field.send_keys("Бирюкова")
    reg_page.email_or_mobile_phone_field.send_keys("test123@mail.ru")
    reg_page.password_field.send_keys("анна00")
    reg_page.password_confirmation_field.send_keys("анна00")
    reg_page.continue_button.click()
    assert reg_page.error_message_password.get_text() == "Длина пароля должна быть не менее 8 символов"


# Тест-кейс N-009
# Регистрация пользователя в форме "Регистрации" в поле ввода "Фамилия" вместо кириллицы введены спецсимволы
...
def test_password_and_password_confirmation_do_not_match(web_browser):
    ...
    reg_page.email_or_mobile_phone_field.send_keys("u15618793@gmail.com")
    reg_page.password_field.send_keys("261320261320Aleks")
    reg_page.password_confirmation_field.send_keys("Qwertyuiop321!")
    reg_page.continue_button.click()
...
def test_authorisation_valid(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys("+79042482516")
    page.password.send_keys("261320261320Aleks")
